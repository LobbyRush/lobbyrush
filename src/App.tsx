...
const filteredLobbies = lobbies.filter(l => { const modeMatch = filterMode === 'All' || l.game_mode === filterMode; const rankMatch = filterRank === 'All' || l.rank.startsWith(filterRank); return modeMatch && rankMatch; });;
